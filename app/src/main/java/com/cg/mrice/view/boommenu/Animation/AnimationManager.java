package com.cg.mrice.view.boommenu.Animation;
...
import com.cg.mrice.view.boommenu.ButtonEnum;

import java.util.ArrayList;
import java.util.Random;

import static com.cg.mrice.view.boommenu.Animation.BoomEnum.LINE;
