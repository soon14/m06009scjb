...
import com.cg.mrice.view.boommenu.Util;
...
public class BuilderManager {
    ...
    private static int[] imageResources = new int[]{
            R.drawable.dynamic_fill, R.drawable.manage_fill, R.drawable.marketing_fill, R.drawable.prompt_fill, R.drawable.share_fill, R.drawable.stealth_fill, R.drawable.task_fill
    };
